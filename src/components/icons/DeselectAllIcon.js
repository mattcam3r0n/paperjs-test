  ...
  return (
    <SvgIcon>
      <svg
        ...
        viewBox="0 0 24 24"
      >
        <path d="M0 21.602h2.398V24H0zM1.2 18H0v2.398h1.2zm0-3.602H0v2.403h1.2zm0-3.597H0v2.398h1.2zm0-3.602H0v2.403h1.2zm0-3.597H0V6h1.2zM21.601 24H24v-2.398h-2.398zm1.199-3.602H24V18h-1.2zm0-3.597H24v-2.403h-1.2zm0-3.602H24v-2.398h-1.2zm0-3.597H24V7.199h-1.2zM22.8 6H24V3.602h-1.2zm-1.2-6v2.398H24V0zM0 2.398h2.398V0H0zM6 0H3.602v1.2H6zm3.602 0H7.199v1.2h2.403zm3.597 0h-2.398v1.2h2.398zm3.602 0h-2.403v1.2h2.403zM18 1.2h2.398V0H18zM3.602 24H6v-1.2H3.602zm3.597 0h2.403v-1.2H7.199zm3.602 0h2.398v-1.2h-2.398zm3.597 0h2.403v-1.2h-2.403zM18 24h2.398v-1.2H18zm-7.2-13.2H3.603V3.603H10.8zm-1.198-6H4.8v4.802h4.8zM10.8 20.399H3.6V13.2h7.2zm-1.2-6h-4.8V19.2h4.8zM13.2 13.2h7.2v7.2h-7.2zm1.2 6h4.8v-4.8h-4.8zm-1.2-15.597h7.2V10.8h-7.2zm1.2 6h4.8V4.8h-4.8zm0 0" />
      </svg>{' '}
    </SvgIcon>
  );
}
